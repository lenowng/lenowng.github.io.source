...
import CustomShopifyAppsPost from './pages/blog/CustomShopifyApps'
    ...
    <BrowserRouter>
      ...
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="blog/custom-shopify-apps" element={<CustomShopifyAppsPost />} />
          <Route path="blog/hydrogen-migration" element={<CustomShopifyAppsPost />} />
